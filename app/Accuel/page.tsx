...
export default function Accuel() {
    ...
    return (
        <>
            ...
            {/* Footer */}
            <footer className="bg-[rgb(249,250,251)] dark:bg-gray-800 text-center p-10 mt-12">
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <h3 className="text-lg font-semibold mb-2">À propos</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            ECES, référence en gestion scolaire, propose un espace centralisé pour tous les acteurs de l'école.
                        </p>
                    </div>
                    <div>
                        <h3 className="text-lg font-semibold mb-2">Contact</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">Rue de l'École, Ville, Pays</p>
                        <p className="text-sm text-gray-600 dark:text-gray-300">+123 456 789</p>
                        <p className="text-sm text-gray-600 dark:text-gray-300">contact@eces.edu</p>
                    </div>
                    <div>
