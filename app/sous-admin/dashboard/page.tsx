    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text">
            Dashboard Sous-Admin
          </h1>
          <p className="text-gray-600 mt-2 dark:text-gray-300">Bienvenue dans votre espace de gestion</p>
        </div>
            ...
            <Card className="group hover:shadow-xl hover:shadow-blue-200/50 transition-all duration-300 border-0 bg-linear-to-br from-white to-blue-50/50 hover:to-blue-50 cursor-pointer">
              <CardHeader className="pb-3 px-4 sm:px-6 py-4 sm:py-6">
                <div className="flex items-center gap-3">
                  <div className={`p-2 sm:p-3 rounded-xl bg-linear-to-br ${getIconColor(stat.color)} shadow-lg`}>
                    <stat.icon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />

                  </div>
                  <div className="flex-1 min-w-0">
                    <CardTitle className="text-xl sm:text-2xl font-bold text-gray-900 truncate">{stat.value}</CardTitle>
                    <CardDescription className="text-sm sm:text-base dark:text-gray-900 truncate">{stat.title}</CardDescription>
                  </div>
                </div>
              </CardHeader>
      ...
      <Card className="bg-linear-to-r from-blue-50 to-indigo-50 border-blue-100">
        <CardHeader className="px-4 sm:px-6 py-4 sm:py-6">
          <CardTitle className="flex items-center dark:text-gray-900 gap-2 text-lg sm:text-xl">
        ...
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 p-4 sm:p-6">
          <Link href="/sous-admin/profil">
            ...
            <Button className="justify-start h-12 sm:h-16 bg-linear-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 shadow-md group text-sm sm:text-base">
          ...
          <Link href="/sous-admin/messages">
            <Button className="justify-start h-12 sm:h-16 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 shadow-md group text-sm sm:text-base">
          ...
          <Link href="/sous-admin/actualites">
            <Button className="justify-start h-12 sm:h-16 bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-md group text-sm sm:text-base">
          ...
          <Link href="/sous-admin/emploi-du-temps">
            <Button className="justify-start h-12 sm:h-16 bg-linear-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 shadow-md group text-sm sm:text-base">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {[
            ...
            <div key={index} className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
