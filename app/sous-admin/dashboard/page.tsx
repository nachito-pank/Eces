  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          <Link key={index} href={stat.href} className="block outline-none">
            <div className="bg-white dark:bg-slate-900/50 rounded-3xl p-6 hover:-translate-y-1 hover:shadow-xl dark:shadow-none transition-all duration-300 border border-slate-200/50 dark:border-slate-800/60 h-full group flex flex-col justify-between">
              
              <div className="flex items-start justify-between mb-4">
                <div className={`p-3 rounded-2xl ${getIconColor(stat.color)} transition-transform duration-300 group-hover:scale-110`}>
                  <stat.icon className="w-6 h-6" />
                </div>
                <div className={`px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-widest ${getBadgeColor(stat.color)}`}>
                  {stat.change}
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 leading-tight">{stat.title}</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        {/* Quick Actions */}
        <motion.div variants={itemVariants} className="lg:col-span-2 bg-white dark:bg-slate-900/50 rounded-[2rem] border border-slate-200/50 dark:border-slate-800/60 p-6 sm:p-8 shadow-sm">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-6">Activités Fréquentes</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            
            <Link href="/sous-admin/messages">
              <div className="flex items-center p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center mr-4 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                  <MessageSquare className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-white text-base">Diffuser un message</h4>
            ...
            <Link href="/sous-admin/actualites">
              <div className="flex items-center p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mr-4 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                  <Newspaper className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-white text-base">Créer une actualité</h4>
            ...
            <Link href="/sous-admin/emploi-du-temps">
              <div className="flex items-center p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/40 text-purple-600 dark:text-purple-400 flex items-center justify-center mr-4 group-hover:bg-purple-600 group-hover:text-white transition-colors">
                  <CalendarDays className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-white text-base">Gérer les Emplois du temps</h4>
            ...
            <Link href="/sous-admin/profil">
              <div className="flex items-center p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 flex items-center justify-center mr-4 group-hover:bg-slate-600 group-hover:text-white transition-colors">
                  <User className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-white text-base">Mon Espace</h4>
        ...
        <motion.div variants={itemVariants} className="bg-white dark:bg-slate-900/50 rounded-[2rem] border border-slate-200/50 dark:border-slate-800/60 p-6 sm:p-8 shadow-sm">
          <div className="flex flex-col mb-6">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Activité Récente</h2>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 mt-2 bg-slate-100 dark:bg-slate-800 rounded-lg w-fit text-xs font-bold text-slate-600 dark:text-slate-400">
          ...
          <div className="space-y-5 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 dark:before:via-slate-800 before:to-transparent">
            {[
              ...
              { action: 'EDT mis à jour (Génie Informatique)', time: 'hier à 14:00', icon: CalendarDays, bg: 'bg-purple-500' },
               ...
               <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  <div className={`flex items-center justify-center w-10 h-10 rounded-xl border-4 border-white dark:border-slate-900 ${activity.bg} text-white shrink-0 md:order-1 relative z-10 mx-0 md:mx-auto shadow-sm`}>
                      <activity.icon className="w-4 h-4" />
                  </div>
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 shadow-sm ml-4 md:ml-0">
