    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-4 sm:p-6 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-yellow-100 rounded-2xl">
                    ...
                    modal.innerHTML = `
                      <div class="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden border border-gray-200">
                        <div class="flex flex-col h-full">
                          <!-- En-tête -->
                          <div class="relative bg-gradient-to-r from-blue-600 to-purple-600 p-4 sm:p-6 text-white">
