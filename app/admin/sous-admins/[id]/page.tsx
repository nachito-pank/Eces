  ...
  const toggleDroit = (droit: string) => {
    ...
    setFormData((p: any) => ({
      ...
      droits: p.droits.includes(droit)
        ? p.droits.filter((d: string) => d !== droit)
        : [...p.droits, droit],
    }));
  };
          ...
          <div className={`${PANEL} overflow-hidden`}>
            ...
            <div className="px-6 pb-6 relative">
              ...
              <div className="pt-14">
                ...
                <div className="mt-3">
                  <span
                    className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${admin.statut === "Actif" ? "bg-green-50 dark:bg-green-900/40 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-800" : "bg-red-50 dark:bg-red-900/40 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800"}`}
                  >
                    {admin.statut}
                  </span>
                </div>
                <div className="mt-5 space-y-2.5">
                  {[
                    { Icon: Mail, val: admin.email },
                    { Icon: Phone, val: admin.telephone || "Non renseigné" },
                    { Icon: Calendar, val: `Créé le ${admin.dateCreation}` },
                  ].map(({ Icon, val }) => (
                    <div
                      key={val}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {ALL_DROITS.map((droit) => {
                const active = isEditing
                  ? formData.droits.includes(droit)
                  : admin.droits.includes(droit);
                return (
                  <div
                    key={droit}
