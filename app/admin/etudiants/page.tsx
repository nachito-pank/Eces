...
export default function EtudiantsPage() {
  ...
  const [etudiants, setEtudiants] = useState(db.etudiants);
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50">
                <th className="text-left p-4 font-semibold text-slate-900">Étudiant</th>
                <th className="text-left p-4 font-semibold text-slate-900">Matricule</th>
                <th className="text-left p-4 font-semibold text-slate-900">Filière</th>
                <th className="text-left p-4 font-semibold text-slate-900">Niveau</th>
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div 
                        ...
                        style={{ backgroundColor: etudiant.couleur }}
                      >
                        {etudiant.avatar}
                      </div>
                      <div>
                        <p className="font-medium text-slate-900">{etudiant.prenom} {etudiant.nom}</p>
